...
function Sidebar() {
        ...
        return (
          <ul>
            {[...sideBarArray].map(([key, value]) => (
              <NavLink exact="true" to={value} classNameName={`text-green ${location.pathname === value ? activeclassName : ''}`}>
                <div key={value} className="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white" >
    ...
    return (
      <aside className="bg-gray-200 w-64 px-4 py-8 flex z-10">
        ...
        <div className="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[250px] overflow-y-auto text-center bg-gray-800">
          <div className="text-gray-100 text-xl mt-[50px]">
            <div className="p-2.5 flex items-center ">
              ...
              <i className="bi bi-x cursor-pointer ml-24 lg:hidden" onClick={openSidebar}></i>
            </div>
